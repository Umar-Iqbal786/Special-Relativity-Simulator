...
function createObjects() {
    ...
    cubePositions.forEach((pos, i) => {
        const cube = new THREE.Mesh(cubeGeometry, relativeMaterial.clone());
    ...
    pyramidPositions.forEach((pos, i) => {
        const pyramid = new THREE.Mesh(pyramidGeometry, relativeMaterial.clone());
    ...
    spherePositions.forEach((pos) => {
        const sphere = new THREE.Mesh(sphereGeometry, relativeMaterial.clone());
